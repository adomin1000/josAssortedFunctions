#################################################### Functions #######################################################
      ...
      ########################################## MSGraph API
            #Check if MSGraph module is installed and if not install it then switch the schema from v1.0 to beta and connect to MS Graph            Function ConnectMSGraphModule {
